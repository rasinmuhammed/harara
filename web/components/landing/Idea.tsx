...
const STEPS: { n: 1 | 2 | 3 | 4; title: string; body: string }[] = [
  {
    ...
    body: "WBGT for a working day in Doha. It reads a heat-stress index in degrees, not just air temperature. The shaded band is the range of plausible forecasts at this lead time.",
  },
  {
    n: 2,
    title: "The line that stops work",
    body: "Qatar Decision 17 of 2021 stops outdoor work at 32.1 on this index. For a Doha summer afternoon the forecast sits above it for hours.",
  },
  {
    n: 3,
    title: "What the fixed rule does",
    body: "The clock ban rests the crew from 10:00 to 15:30 and works full rate the rest of the day, whatever the forecast says. It works them hard right up to the ban and again right after.",
  },
  {
    n: 4,
    title: "What the plan does",
    body: "Same total hours. It works the cool morning at full rate, eases through the forecast peak, and picks the work back up as the heat drops, so the worst retained heat load is lower.",
  },
];
      ...
      <div className="mx-auto max-w-content px-5">
        <Reveal>
          ...
          <p className="mt-3 max-w-prose text-lg text-ink-secondary">
            One working day in Doha, built up in four steps.
          </p>
        </Reveal>
