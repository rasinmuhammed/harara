...
| How much additional protection can a forecast-driven plan add on top of the fixed window? | A risk-optimal scheduler cut mean peak heat load by about 14 percent and the worst-case tail by 16 to 20 percent, at the same total work output, at every forecast lead, with no shortfall in any trial. This is a simulation on real past weather. |
