...
| Richmond et al. treadmill set (Dataset 1 in the 2026 *Build. Environ.* review, PMC13328076) | none given | 16 (8 M, 8 F) | HR, rectal, 11-site skin | Rectal | n/a | This is the same PROSPIE lineage (Havenith / Richmond); the openly posted PROSPIE workbook is the usable instance. |
| 2026 *Build. Environ.* standardized-evaluation review | no data-availability statement, no benchmark release | n/a | n/a | n/a | n/a | Review only; neither of its two datasets is posted. |
...
| PhysioNet thermoregulation search | n/a | n/a | wrist/ambient temp only in the near matches | not gold | n/a | No gold core-temp + HR exercise set found on PhysioNet. |
